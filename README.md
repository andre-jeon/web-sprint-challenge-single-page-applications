...
Validation will kick in when requirements are not met to proceed. 
1. In 1-2 sentences, define end to end testing.
The end to end testing will test all the component in the form to see if everything is working properly.
